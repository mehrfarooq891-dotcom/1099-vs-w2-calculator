      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto space-y-20">
          ...
          <div className="text-center space-y-6">
            <h1 className="text-5xl md:text-7xl font-black tracking-tighter text-text-primary">About W2 vs 1099 Calculator</h1>
          ...
          <div className="pt-12 border-t border-border-color/30 text-center">
            <p className="text-xs text-text-muted font-mono uppercase tracking-widest">
              W2 vs 1099 Calculator is a free online US W2 vs 1099 tax calculator for USA. Use it anytime with no registration required.
            </p>
          </div>
        </div>
      </section>
